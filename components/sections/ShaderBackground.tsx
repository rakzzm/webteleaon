...
const fragmentShaderSource = `
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.09, 0.79, 0.96, 1.0);
    vec4 bgColor2 = vec4(0.88, 0.0, 0.51, 1.0);
    ...
    fragColor *= mix(0.58, 1.0, verticalFade);
    fragColor.a = 1.0;
    fragColor += lines;
...
export function ShaderBackground({ className = "" }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      gl.uniform1f(time, (performance.now() - startTime) / 1000);
      gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
