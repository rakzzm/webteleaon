...
> = {
  sm: {
    ...
    tabLeft: "h-3 w-9 rounded-tl-lg",
    tabRight: "h-3 w-2 rounded-tr-[24px]",
    tabBridge: "h-2 w-2",
    flapBody: "h-9",
    papers: "inset-x-5 top-2",
    paperOffset: "top-1",
    paperH: "h-16",
    paperContent: "space-y-1 px-2.5 pt-2.5",
    label: "bottom-2 left-2 px-1.5 py-0.5 text-[9px]",
    hoverY: -3,
    hoverBackY: -4
  },
  md: {
    container: "size-32 rounded-[32px]",
    tabLeft: "h-4 w-12 rounded-tl-lg",
    tabRight: "h-4 w-2.5 rounded-tr-[32px]",
    tabBridge: "h-2.5 w-2.5",
    flapBody: "h-12",
    papers: "inset-x-6 top-3",
    paperOffset: "top-1.5",
    paperH: "h-24",
    paperContent: "space-y-1 px-3 pt-3",
    label: "bottom-3 left-3 px-1.5 py-0.5 text-[10px]",
    hoverY: -3,
    hoverBackY: -5
  },
  lg: {
    container: "size-40 rounded-[40px]",
    tabLeft: "h-[1.375rem] w-16 rounded-tl-xl",
    tabRight: "h-[1.375rem] w-[0.8125rem] rounded-tr-[40px]",
    tabBridge: "h-[0.8125rem] w-[0.8125rem]",
    flapBody: "h-16",
    papers: "inset-x-8 top-4",
    paperOffset: "top-2",
    paperH: "h-[7.5rem]",
    paperContent: "space-y-1.5 px-4 pt-4",
    label: "bottom-4 left-4 px-2 py-1 text-xs",
    hoverY: -4,
    hoverBackY: -6
  }
};
...
export function Folder({ color = "blue", size = "lg", label, className }: FolderProps) {
  ...
  return (
    <motion.div
      ...
      animate="rest"
      variants={{ rest: {}, hover: {} }}
      className={cn("relative cursor-pointer overflow-hidden border-t-2 bg-gradient-to-b", s.container, c.folder, c.folderBorder, className)}
    >
